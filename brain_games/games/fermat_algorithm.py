...
#Main function to print text and check results from fermat_calculations funcion
def fermat_alg():
    count = 3
...
# Function to create random number and make 3 Fermat test to check if number is prime
